...
.. |1| image:: /media/BLE_PWM_over_BLE_UART/image1.png
   :width: 1383
   :height: 1048
   :scale: 50 %
.. |1-1| image:: /media/BLE_PWM_over_BLE_UART/image1-1.png
   :width: 1012
   :height: 699
   :scale: 55 %
.. |1-2| image:: /media/BLE_PWM_over_BLE_UART/image1-2.png
   :width: 1564
   :height: 1079
   :scale: 35 %
.. |2| image:: /media/BLE_PWM_over_BLE_UART/image2.png
   :width: 682
   :height: 1202
   :scale: 70%
.. |3| image:: /media/BLE_PWM_over_BLE_UART/image3.png
   :width: 1440
   :height: 2880
   :scale: 25%
.. |4| image:: /media/BLE_PWM_over_BLE_UART/image4.png
   :width: 1440
   :height: 2880
   :scale: 25%
.. |5| image:: /media/BLE_PWM_over_BLE_UART/image5.png
   :width: 1440
   :height: 2880
   :scale: 25%
.. |6| image:: /media/BLE_PWM_over_BLE_UART/image6.png
   :width: 1440
   :height: 2880
   :scale: 25%